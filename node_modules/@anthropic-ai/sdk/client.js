...
class BaseAnthropic {
     ...
     */
    _credentialsFetch() {
        return (0, middleware_1.wrapFetchWithMiddleware)(this.fetch, this.middleware);
    }
    ...
    async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
        ...
        const response = await this.fetchWithTimeout(url, req, timeout, controller, options).catch(errors_1.castToError);
    ...
    async fetchWithTimeout(url, init, ms, controller, requestOptions) {
        ...
        return await (0, middleware_1.wrapFetchWithMiddleware)(timedFetch, allMiddleware, requestOptions)(url, fetchOptions);
    }
