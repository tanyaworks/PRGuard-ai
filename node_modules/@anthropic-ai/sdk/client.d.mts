...
export declare class BaseAnthropic {
    ...
    fetchWithTimeout(url: RequestInfo, init: RequestInit | undefined, ms: number, controller: AbortController, requestOptions?: FinalRequestOptions | undefined): Promise<Response>;
    private shouldRetry;
